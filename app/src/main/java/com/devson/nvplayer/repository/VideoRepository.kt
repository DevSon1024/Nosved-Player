...
class VideoRepository(private val context: Context) {
    ...
    suspend fun getFoldersWithVideos(): Map<com.devson.nvplayer.model.VideoFolder, List<Video>> {
        val allVideos = getAllVideos()
        return allVideos.groupBy { com.devson.nvplayer.model.VideoFolder(it.folderId, it.folderName) }
    }
}

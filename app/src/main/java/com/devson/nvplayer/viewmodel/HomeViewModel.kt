...
class HomeViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val history: StateFlow<List<WatchHistory>> = kotlinx.coroutines.flow.combine(
        ...
        com.devson.nvplayer.repository.ViewSettingsRepository(application.applicationContext).viewSettingsFlow
    ...
    val latestVideos: StateFlow<List<Video>> = com.devson.nvplayer.repository.ViewSettingsRepository(application.applicationContext).viewSettingsFlow
        .map { settings ->
    ...
    val uiState: StateFlow<HomeUiState> = com.devson.nvplayer.repository.ViewSettingsRepository(application.applicationContext).viewSettingsFlow
        .map { settings ->
